...
**一次按住期间是绝对映射，允许越界。** 手伸到可达域外时末端就停在边界上，
而手还在继续往前；要让手臂重新动起来，**必须把越界的那一段原样空推回去**。
想省掉这段空推就**松开 squeeze 再按一次**：重新接合会拿当前 `limited_pose` 重新做锚点，
越界的那段作废，从当下位置 1:1 接着走。

不要拿可达性反馈去修离合锚点来“取消空推”。那样够不着的那段位移会被吸进锚点、
把整个手↔手臂映射平移：实测前推 80 cm 再把手原路收回接合点，手臂停在接合点
